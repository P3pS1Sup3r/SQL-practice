-- Сравнение производительности магазинов
-- Сравните два магазина в базе данных Pagila по следующим показателям:
-- Идентификатор магазина
-- Дата платежа (группировка по неделям)
-- Количество платежей за неделю
-- Сумма платежей за неделю
-- Доля магазина в общем объеме продаж за неделю
-- Средний чек магазина по сравнению со средним чеком другого магазина (как процентное соотношение)
