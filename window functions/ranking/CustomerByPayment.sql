-- Ранжировать клиентов по сумме их платежей:
-- Присвойте ранг каждому клиенту в зависимости от общей суммы его платежей
-- Используйте разные типы ранжирования: ROW_NUMBER(), RANK() и DENSE_RANK()
-- Сравните результаты этих функций
