...
-- Для каждого месяца и категории фильмов:
-- Количество прокатов в текущем месяце
-- Количество прокатов в предыдущем месяце
-- Количество прокатов в том же месяце предыдущего года
-- Процентное изменение по сравнению с предыдущим месяцем
-- Процентное изменение по сравнению с тем же месяцем предыдущего года
